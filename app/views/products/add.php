  ...
  <div class="container-fluid px-4">
    ...
    <div class="row align-items-center">
      <div class="col mx-auto">
        <form class="p-4 p-md-5 border rounded-3 bg-light" action="<?php echo URLROOT; ?>/products/add" method="POST" id="formProduct" enctype="multipart/form-data">
          ...
          <div class="d-flex gap-2">
            <input class="w-100 btn btn-success btn-lg" type="submit" value="Add Product">
