          ...
          <div class="col-md-6 col-lg-12 mb-5">
            <div class="card" style="width: 18rem;">
              <div class="card-header">
                <h4 class="mb-0 span-orange py-3"><strong>Categories</strong></h4>
              </div>
              <ul class="list-group list-group-flush">
                <?php foreach ($data['categories'] as $category) : ?>
                  <li class="list-group-item">
                    <a href="<?php echo URLROOT; ?>/pages/category/<?php echo $category->category_id; ?>"" class=" lead"><?php echo $category->category_name; ?></a>
                  </li>
                <?php endforeach; ?>
              </ul>
            </div>
            ...
            <div class="card shadow-sm">
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <small class="text-muted fs-4">&#8369;<?php echo $product->product_price; ?></small>
                </div>
              </div>
            </div>
          </div>
