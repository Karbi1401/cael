...
<main class="container col-xl-10 col-xxl-8 px-4 py-5">
  <div class="row align-items-center g-lg-5 py-5">
    ...
    <div class="col-md-10 mx-auto col-lg-5">
      <form class="p-4 p-md-5 border rounded-3 bg-light" action="<?php echo URLROOT; ?>/admins/login" method="POST">
        <?php
        flash('user_message');
        ?>
        <h2 class="mb-3"><span class="span-orange">Admin Login</span></h2>
        <div class="mb-3">
